...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 17.1; // in
    ...
    public static double MAX_ANG_VEL = 6.436453342869841;
    public static double MAX_ANG_ACCEL = Math.toRadians(224.64430512428265);
